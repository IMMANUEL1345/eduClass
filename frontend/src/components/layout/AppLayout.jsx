      ...
      <aside className="w-52 flex-shrink-0 flex flex-col bg-white border-r border-gray-100">
        ...
        <div className="p-3 border-t border-gray-100">
          <div className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-gray-50">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium flex-shrink-0 ${ROLE_COLOR[user?.role] || 'bg-gray-100 text-gray-600'}`}>
              {initials}
            </div>
            ...
            <button onClick={handleLogout} title="Logout" className="p-1 rounded hover:bg-gray-200 text-gray-400">
